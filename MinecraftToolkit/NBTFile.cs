...
namespace Substrate.Core
{
    ...
    public class NBTFile
    {
        ...
        public virtual Stream GetDataOutputStream(CompressionType compression = CompressionType.GZip)
        {
            try {
                switch (compression) {
                    case CompressionType.None:
    ...
    {
        public static int GetTimestamp(this DateTime time) => (int)(time - DateTime.UnixEpoch).TotalSeconds;
    }
}
